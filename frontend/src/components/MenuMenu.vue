<template>
    <v-card style="width:450px; height:100%;" outlined>
        ...
        <v-card-text>
            ...
            <Number label="Discount" v-model="value.discount" :editMode="editMode" :inputUI="''"/>
            <Number label="TodayOrderCount" v-model="value.todayOrderCount" :editMode="editMode" :inputUI="''"/>
